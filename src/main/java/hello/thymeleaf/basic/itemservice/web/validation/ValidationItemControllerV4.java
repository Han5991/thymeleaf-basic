...
import hello.thymeleaf.basic.itemservice.domain.item.SaveCheck;
import hello.thymeleaf.basic.itemservice.domain.item.UpdateCheck;
import hello.thymeleaf.basic.itemservice.web.validation.form.ItemSaveForm;
import hello.thymeleaf.basic.itemservice.web.validation.form.ItemUpdateForm;
...
public class ValidationItemControllerV4 {
    ...
    public String edit(@PathVariable Long itemId, @Validated @ModelAttribute("item") ItemUpdateForm form, BindingResult bindResult) {
        if (form.getPrice() != null && form.getQuantity() != null) {
