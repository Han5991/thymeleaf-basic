...
public class ValidationItemControllerV2 {
    ...
    //    @PostMapping("/add")
    public String addItemV4(@ModelAttribute Item item, BindingResult bindResult, RedirectAttributes redirectAttributes) {
        //검증 로직
        ValidationUtils.rejectIfEmptyOrWhitespace(bindResult, "itemName", "required");
//        if (!StringUtils.hasText(item.getItemName())) {
...
//        }
    ...
    //    @PostMapping("/add")
    public String addItemV5(@ModelAttribute Item item, BindingResult bindResult, RedirectAttributes redirectAttributes) {
        //검증로직
    ...
    @PostMapping("/add")
    public String addItemV6(@Validated @ModelAttribute Item item, BindingResult bindResult, RedirectAttributes redirectAttributes) {
        if (bindResult.hasErrors()) {
            return "validation/v2/addForm";
        }
